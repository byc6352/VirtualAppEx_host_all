...
public class FloatWindowManager {
    ...
    public boolean applyOrShowFloatWindow(Context context) {
        if (hasFloatWindowAccessPermission(context)) {
        //if (checkPermission(context)) {
            //showWindow(context);
            //Toast.makeText(context, "已授予悬浮窗权限！", Toast.LENGTH_LONG).show();
            return true;
        } else {
            String say=context.getString(R.string.float_window_permisson_toast);
    ...
    private void showConfirmDialog(Context context, OnConfirmResult result) {
        showConfirmDialog(context, context.getString(R.string.float_window_no_permisson_show), result);
    }
    ...
    private void showConfirmDialog(Context context, String message, final OnConfirmResult result) {
        ...
        dialog = new AlertDialog.Builder(context).setCancelable(true).setTitle(R.string.float_window_title)
                .setMessage(message)
                .setPositiveButton(R.string.float_window_button_open,
                        ...
                        }).setNegativeButton(R.string.float_window_button_no,
                        new DialogInterface.OnClickListener() {
